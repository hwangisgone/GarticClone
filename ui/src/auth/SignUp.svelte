<script>
    ...
    <div class = 'myDiv'>
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden justify-center" style="max-width:1000px">
            <div class="md:flex w-full">
                <div class="hidden md:block w-1/2 bg-neutral py-10 px-10">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    ...
                    <div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <!-- Register here -->
                                <button on:click={()=> $UIstate = 0}   class="block w-full max-w-xs mx-auto bg-neutral hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                            </div>
                        </div>
                        <p class="text-sm text-center text-gray-400" style = "font-size:16px">You have an account ? <a on:click={()=> $UIstate = 0}  href="#!" class="text-indigo-400 focus:outline-none focus:underline focus:text-indigo-500 dark:focus:border-indigo-800">Sign in here</a>.</p>
                    </div>
                </div>
            </div>
        </div>
